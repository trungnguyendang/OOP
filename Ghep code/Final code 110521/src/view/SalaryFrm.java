 ...
 * @author judy
 */
public class SalaryFrm extends javax.swing.JDialog {

    /**
     * Creates new form SalaryFrm
     */
    private MainBoardFrm main;
    public SalaryFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Input the salary");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SalaryFrm dialog = new SalaryFrm(new javax.swing.JFrame(), true);
