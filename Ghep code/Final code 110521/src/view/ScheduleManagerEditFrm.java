 ...
 * @author judy
 */
public class ScheduleManagerEditFrm extends javax.swing.JDialog {
    ...
    public ScheduleManagerEditFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnAddManagerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddManagerActionPerformed
        ...
        if (isOK) {
            ...
            main.updateScheduleManagerFrm(scheduleManager);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScheduleManagerEditFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ScheduleManagerEditFrm dialog = new ScheduleManagerEditFrm(new javax.swing.JFrame(), true);
    ...
    public void setEditData(ScheduleManager s1) {
        dateSchedule.setDate(s1.getDate());
        optManagerID1.setSelectedItem(s1.getManagerID1().toString());
        optManagerID2.setSelectedItem(s1.getManagerID2().toString());
    }
}
