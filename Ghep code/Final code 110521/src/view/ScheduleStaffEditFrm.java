 ...
 * @author judy
 */
public class ScheduleStaffEditFrm extends javax.swing.JDialog {
    ...
    public ScheduleStaffEditFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        main = (MainBoardFrm) parent;
        this.setTitle("Input the schedule for staff");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT THE STAFF SCHEDULE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (isOK) {
            ...
            main.updateScheduleStaffFrm(scheduleStaff);
            JOptionPane.showMessageDialog(rootPane, "Successfsully added!");
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScheduleStaffEditFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ScheduleStaffEditFrm dialog = new ScheduleStaffEditFrm(new javax.swing.JFrame(), true);
    ...
    public void setEditData(ScheduleStaff s2) {
        dateSchedule.setDate(s2.getDate());
        optStaffID1.setSelectedItem(s2.getStaffId1());
        optStaffID2.setSelectedItem(s2.getStaffId2());
        optStaffID3.setSelectedItem(s2.getStaffId3());
        optStaffID4.setSelectedItem(s2.getStaffId4());
        optStaffID5.setSelectedItem(s2.getStaffId5());
        optStaffID6.setSelectedItem(s2.getStaffId6());
        optStaffID7.setSelectedItem(s2.getStaffId7());
    }
}
